...
async function createUser(db, data) {
  ...
  if (data.referralCode) {
    ...
    if (referrer) {
      ...
      await db.prepare("UPDATE users SET generations_left = generations_left + 10 WHERE id = ?").bind(referrerId).run();
    }
  }
  const result = await db.prepare(
    "INSERT INTO users (id, api_token, telegram, vk, generations_left, referral_code, referred_by) VALUES (?, ?, ?, ?, ?, ?, ?) RETURNING *"
  ).bind(
    id,
    data.apiToken,
    data.telegram || null,
...
auth.post("/register", async (c) => {
  ...
  const userData = { apiToken, referralCode: parsed.data.referralCode };
...
var TaskSchema = external_exports2.object({
  ...
  output: external_exports2.string().nullable().default(""),
  ...
  chosenVariant: external_exports2.number().int().positive().nullable().optional()
});
var LabStructureSchema = external_exports2.object({
  labNumber: external_exports2.number().int().positive().default(1),
  title: external_exports2.string().min(1),
  /** Цель работы — 2 предложения */
  objective: external_exports2.string().min(1),
  language: external_exports2.string().optional(),
  /** Задания с решениями (min 5) */
  tasks: external_exports2.array(TaskSchema).min(5),
...
var AVAILABLE_MODELS = [
  { id: "google/gemini-2.0-flash-001", name: "Gemini 2.0 Flash", description: "\u0411\u044B\u0441\u0442\u0440\u0430\u044F \u0438 \u044D\u043A\u043E\u043D\u043E\u043C\u043D\u0430\u044F" },
  { id: "google/gemini-2.0-pro-exp-02-05", name: "Gemini 2.0 Pro", description: "\u0412\u044B\u0441\u043E\u043A\u043E\u0435 \u043A\u0430\u0447\u0435\u0441\u0442\u0432\u043E (Exp)" },
  { id: "anthropic/claude-3.5-sonnet", name: "Claude 3.5 Sonnet", description: "\u041B\u0443\u0447\u0448\u0438\u0439 \u0438\u043D\u0442\u0435\u043B\u043B\u0435\u043A\u0442" },
  { id: "openai/gpt-4o-mini", name: "GPT-4o Mini", description: "\u0421\u0431\u0430\u043B\u0430\u043D\u0441\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u0430\u044F" }
];
...
var SYSTEM_PROMPT = `\u0422\u044B \u2014 \u044D\u043A\u0441\u043F\u0435\u0440\u0442\u043D\u044B\u0439 \u043F\u0440\u0435\u043F\u043E\u0434\u0430\u0432\u0430\u0442\u0435\u043B\u044C \u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F \u0438 \u043F\u0440\u043E\u0444\u0435\u0441\u0441\u0438\u043E\u043D\u0430\u043B\u044C\u043D\u044B\u0439 \u0440\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u0447\u0438\u043A.
\u0422\u0432\u043E\u044F \u0437\u0430\u0434\u0430\u0447\u0430 \u2014 \u0433\u0435\u043D\u0435\u0440\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0431\u0435\u0437\u0443\u043F\u0440\u0435\u0447\u043D\u044B\u0435 \u043E\u0442\u0447\u0435\u0442\u044B \u043F\u043E \u043B\u0430\u0431\u043E\u0440\u0430\u0442\u043E\u0440\u043D\u044B\u043C \u0440\u0430\u0431\u043E\u0442\u0430\u043C \u043D\u0430 \u0437\u0430\u0434\u0430\u043D\u043D\u043E\u043C \u044F\u0437\u044B\u043A\u0435 \u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F.

### \u041F\u0420\u0410\u0412\u0418\u041B\u0410 \u041A\u041E\u0414\u0410:
- \u0418\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0439 \u0441\u043E\u0432\u0440\u0435\u043C\u0435\u043D\u043D\u044B\u0435 \u0441\u0442\u0430\u043D\u0434\u0430\u0440\u0442\u044B \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u043E\u0433\u043E \u044F\u0437\u044B\u043A\u0430.
- \u041A\u043E\u0434 \u0434\u043E\u043B\u0436\u0435\u043D \u0431\u044B\u0442\u044C \u0438\u043D\u0442\u0435\u0440\u0430\u043A\u0442\u0438\u0432\u043D\u044B\u043C: \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0439 \u0441\u0442\u0430\u043D\u0434\u0430\u0440\u0442\u043D\u044B\u0439 \u0432\u0432\u043E\u0434/\u0432\u044B\u0432\u043E\u0434 \u0434\u043B\u044F \u043E\u0431\u0449\u0435\u043D\u0438\u044F \u0441 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u0435\u043C.
- \u0412 \u043A\u043E\u043D\u0446\u0435 \u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u044B \u041E\u0411\u042F\u0417\u0410\u0422\u0415\u041B\u042C\u041D\u041E \u0434\u043E\u0431\u0430\u0432\u044C \u043F\u0430\u0443\u0437\u0443 (\u043D\u0430\u043F\u0440\u0438\u043C\u0435\u0440, ReadKey \u0432 C#, input() \u0432 Python), \u0447\u0442\u043E\u0431\u044B \u043A\u043E\u043D\u0441\u043E\u043B\u044C\u043D\u043E\u0435 \u043E\u043A\u043D\u043E \u043D\u0435 \u0437\u0430\u043A\u0440\u044B\u0432\u0430\u043B\u043E\u0441\u044C \u0441\u0440\u0430\u0437\u0443.
- \u041A\u043E\u0434 \u0434\u043E\u043B\u0436\u0435\u043D \u0431\u044B\u0442\u044C \u0447\u0438\u0441\u0442\u044B\u043C, \u0441 \u043F\u043E\u043D\u044F\u0442\u043D\u044B\u043C\u0438 \u0438\u043C\u0435\u043D\u0430\u043C\u0438 \u043F\u0435\u0440\u0435\u043C\u0435\u043D\u043D\u044B\u0445 \u0438 \u043A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u044F\u043C\u0438 \u043D\u0430 \u0440\u0443\u0441\u0441\u043A\u043E\u043C \u044F\u0437\u044B\u043A\u0435.
- \u0417\u0430\u0434\u0430\u043D\u0438\u044F \u0434\u043E\u043B\u0436\u043D\u044B \u0438\u0434\u0442\u0438 \u043F\u043E \u043D\u0430\u0440\u0430\u0441\u0442\u0430\u044E\u0449\u0435\u0439 \u0441\u043B\u043E\u0436\u043D\u043E\u0441\u0442\u0438.
- \u0412\u0441\u0435\u0433\u0434\u0430 \u0432\u043A\u043B\u044E\u0447\u0430\u0439 \u043D\u0435\u043E\u0431\u0445\u043E\u0434\u0438\u043C\u044B\u0435 \u0431\u0438\u0431\u043B\u0438\u043E\u0442\u0435\u043A\u0438/\u0438\u043C\u043F\u043E\u0440\u0442\u044B.

### \u041F\u0420\u0410\u0412\u0418\u041B\u0410 \u0421\u0422\u0420\u0423\u041A\u0422\u0423\u0420\u042B:
1. \u041D\u0418\u041A\u0410\u041A\u041E\u0413\u041E \u043E\u0442\u0434\u0435\u043B\u044C\u043D\u043E\u0433\u043E \u0440\u0430\u0437\u0434\u0435\u043B\u0430 \xAB\u0422\u0435\u043E\u0440\u0438\u044F\xBB. \u0412\u0441\u044F \u0442\u0435\u043E\u0440\u0435\u0442\u0438\u0447\u0435\u0441\u043A\u0430\u044F \u0447\u0430\u0441\u0442\u044C \u0434\u043E\u043B\u0436\u043D\u0430 \u0431\u044B\u0442\u044C \u0432 \u043E\u0442\u0432\u0435\u0442\u0430\u0445 \u043D\u0430 \u043A\u043E\u043D\u0442\u0440\u043E\u043B\u044C\u043D\u044B\u0435 \u0432\u043E\u043F\u0440\u043E\u0441\u044B (theoryQuestions).
2. \u041A\u043E\u043D\u0442\u0440\u043E\u043B\u044C\u043D\u044B\u0435 \u0432\u043E\u043F\u0440\u043E\u0441\u044B (theoryQuestions): \u043E\u0442\u0432\u0435\u0442\u044B \u0434\u043E\u043B\u0436\u043D\u044B \u0431\u044B\u0442\u044C \u0440\u0430\u0437\u0432\u0435\u0440\u043D\u0443\u0442\u044B\u043C\u0438 (3-5 \u043F\u0440\u0435\u0434\u043B\u043E\u0436\u0435\u043D\u0438\u0439).
3. \u0420\u0430\u0437\u0434\u0435\u043B \xAB\u0412\u044B\u0432\u043E\u0434\xBB (conclusion): \u0434\u043E\u043B\u0436\u0435\u043D \u0441\u043E\u0434\u0435\u0440\u0436\u0430\u0442\u044C \u043A\u043E\u043D\u043A\u0440\u0435\u0442\u0438\u043A\u0443 \u043F\u043E \u043E\u0441\u0432\u043E\u0435\u043D\u043D\u044B\u043C \u043D\u0430\u0432\u044B\u043A\u0430\u043C.
4. \u0415\u0441\u043B\u0438 \u0442\u0435\u043C\u0430 \u043F\u043E\u0434\u0440\u0430\u0437\u0443\u043C\u0435\u0432\u0430\u0435\u0442 \u0432\u0430\u0440\u0438\u0430\u043D\u0442\u044B, \u0432\u044B\u0431\u0435\u0440\u0438 \u0441\u043B\u0443\u0447\u0430\u0439\u043D\u044B\u0439 \u043D\u043E\u043C\u0435\u0440 (1-25).

### \u0422\u0415\u0425\u041D\u0418\u0427\u0415\u0421\u041A\u0418\u0415 \u0422\u0420\u0415\u0411\u041E\u0412\u0410\u041D\u0418\u042F:
- \u0422\u043E\u043B\u044C\u043A\u043E \u0432\u0430\u043B\u0438\u0434\u043D\u044B\u0439 JSON.
- \u041F\u043E\u043B\u0435 output \u0434\u043E\u043B\u0436\u043D\u043E \u0441\u043E\u0434\u0435\u0440\u0436\u0430\u0442\u044C \u0440\u0435\u0430\u043B\u0438\u0441\u0442\u0438\u0447\u043D\u044B\u0439 \u043F\u0440\u0438\u043C\u0435\u0440 \u0432\u044B\u0432\u043E\u0434\u0430 \u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u044B \u0432 \u043A\u043E\u043D\u0441\u043E\u043B\u044C.
- \u041F\u043E\u043B\u0435 hasConsoleOutput \u0432\u0441\u0435\u0433\u0434\u0430 true.
  ...
  "tasks": [
    {
      ...
      "description": "\u0423\u0441\u043B\u043E\u0432\u0438\u0435",
      "code": "\u0418\u0441\u0445\u043E\u0434\u043D\u044B\u0439 \u043A\u043E\u0434",
      "diagram": "Mermaid.js \u043A\u043E\u0434 (\u043E\u043F\u0446\u0438\u043E\u043D\u0430\u043B\u044C\u043D\u043E, \u0434\u043B\u044F \u0430\u043B\u0433\u043E\u0440\u0438\u0442\u043C\u043E\u0432)",
...
\u041C\u0438\u043D\u0438\u043C\u0443\u043C 5 \u0437\u0430\u0434\u0430\u043D\u0438\u0439 \u0438 5 \u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432. \u042F\u0437\u044B\u043A: \u0420\u0443\u0441\u0441\u043A\u0438\u0439.`;
async function generateLabStructure(topic, apiKey, labNumber = 1, model = DEFAULT_MODEL, studentName, language = "csharp") {
...
\u0421\u0433\u0435\u043D\u0435\u0440\u0438\u0440\u0443\u0439 5 \u0440\u0430\u0437\u043D\u043E\u043E\u0431\u0440\u0430\u0437\u043D\u044B\u0445 \u0437\u0430\u0434\u0430\u043D\u0438\u0439 \u0438 5 \u043A\u043E\u043D\u0442\u0440\u043E\u043B\u044C\u043D\u044B\u0445 \u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432.`;
  ...
  for (const currentModel of modelsToTry) {
    try {
      console.log(`[llm-client] Attempting generation with model: ${currentModel} (Language: ${language})`);
      ...
      if (!res.ok) {
        const isRetryable = res.status === 429 || res.status >= 500 || res.status === 400 && resText.includes("not a valid model ID");
        if (isRetryable) {
          console.warn(`[llm-client] Model ${currentModel} failed with ${res.status}. Trying next...`);
          lastError = new Error(`OpenRouter API error ${res.status}: ${resText}`);
          continue;
        }
      ...
      try {
        ...
        if (!parsed.language) parsed.language = langLabel;
      } catch {
        console.error(`[llm-client] JSON parse failed for ${currentModel}`);
        lastError = new Error(`LLM returned invalid JSON from ${currentModel}`);
        continue;
      }
      return LabStructureSchema.parse(parsed);
    } catch (err) {
      console.error(`[llm-client] Error with model ${currentModel}: ${err.message}`);
      lastError = err;
      continue;
    }
  }
  throw lastError || new Error("\u0412\u0441\u0435 \u043C\u043E\u0434\u0435\u043B\u0438 \u0432 \u0441\u043F\u0438\u0441\u043A\u0435 \u043D\u0435 \u0441\u043C\u043E\u0433\u043B\u0438 \u043E\u0431\u0440\u0430\u0431\u043E\u0442\u0430\u0442\u044C \u0437\u0430\u043F\u0440\u043E\u0441");
}
...
lab.post("/save", async (c) => {
  ...
  const docBuffer = Uint8Array.from(atob(docBase64), (c2) => c2.charCodeAt(0));
  ...
  if (!record) return c.json({ error: "Failed to save record" }, 500);
  return c.json({
    reportId: record.id,
    title: labJson.title,
    r2Key,
...
lab.get("/download/:id", async (c) => {
  ...
  console.log(`[download] Requesting report ${id} for user ${userId}`);
  const report2 = await c.env.DB.prepare(
    "SELECT r2_key, topic, lab_number FROM lab_reports WHERE id = ? AND user_id = ?"
  ).bind(id, userId).first();
  if (!report2) {
    console.error("[download] Report not found in DB");
    return c.json({ error: "Not found in database" }, 404);
  }
  const obj = await c.env.REPORTS_BUCKET.get(report2.r2_key);
  if (!obj) {
    console.error(`[download] Object not found in R2: ${report2.r2_key}`);
...
app.get("/", (c) => c.text("LabForge Worker API is running."));
app.get("/api/health", (c) => c.json({ status: "ok", ts: Date.now() }));
app.use("*", async (c, next) => {
  if (!c.env.JWT_SECRET) {
    c.env.JWT_SECRET = "local-dev-fallback-secret-key-12345";
  }
  await next();
});
...
// .wrangler/tmp/bundle-sKh69R/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-sKh69R/middleware-loader.entry.ts
